      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent className="flex flex-col sm:max-w-lg">
          ...
          <div className="flex items-center justify-between gap-5">
            ...
            <CheckoutButton
              size={"lg"}
              disabled={totalQuantity === 0 || cartQuery.isFetching}
            />
          </div>
        </SheetContent>
      </Sheet>
...
function ShoppingCartItem({
  ...
  const removteItemMutation = useRemoveCartItem();
    ...
    <li className="flex items-center gap-3">
      <div className="relative size-fit flex-none">
        ...
        <button
          ...
          onClick={() => removteItemMutation.mutate(productId)}
        >
          <X className="size-3" />
        </button>
      </div>
      ...
      <div className="space-y-1.5 text-sm">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {quantityLimitReached && <span>Quantitity limit reached</span>}
        </div>
      </div>
    </li>
  );
